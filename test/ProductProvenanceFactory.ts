...
describe("Unit tests", function () {
  ...
  describe("ProductProvenanceFactory", function () {
    ...
    beforeEach(async function () {
      ...
      productProvenanceFactory = <ProductProvenanceFactory>await deployContract(admin, productProvenanceFactoryArtifact);
    });
    ...
    it("should create asset type", async () => {
      ...
      const resultAssetHistory = await productProvenance.connect(admin).getAssetHistoryByContract(assetContractAddress[0])
